#!/usr/bin/env python3
"""
Test the project API endpoints directly
"""
...
# Import the project listing function directly
async def test_project_listing():
    """Test the project listing logic directly"""
    print("🧪 Testing Project Listing Logic Directly")
    print("=" * 50)
    ...
    # Get projects from git pull (stored in projects directory)
    ...
    for project in all_projects:
        print(f"  - {project['name']}: {project['file_count']} Python files")
        print(f"    Path: {project['path']}")
        print(f"    Other files: {len(project['structure']['other_files'])}")
    
    return all_projects

if __name__ == "__main__":
    asyncio.run(test_project_listing())
